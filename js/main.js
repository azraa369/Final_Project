...
(function () {
  ...
  var translations = {
    tr: {
      ...
      "aboutEdu.card1Desc": "Alanya Alaaddin Keykubat Üniversitesi Psikolojik Danışmanlık ve Rehberlik Bölümü'nden 2021 yılında mezun olmuştur.",
      "aboutEdu.card2Title": "Mesleki Deneyim",
      "aboutEdu.card2Desc": "Meslek hayatına Alanya'da özel bir psikolojik danışmanlık ofisinde başlamış, burada iki yıl boyunca danışanlarla çalışmıştır. Son iki yıldır Eskişehir'de kendi danışmanlık ofisinde bireysel ve çevrim içi danışmanlık hizmeti sunmaktadır.",
      "aboutEdu.card3Title": "Çalışma Alanları",
      "aboutEdu.card3Desc": "Kaygı, depresyon ve anksiyete alanlarında psikolojik danışmanlık desteği sunmaktadır. Bunun yanında eğitim koçluğu, tercih danışmanlığı, akademik motivasyon ve yaşam süreçlerine uyum konularında danışanlarına rehberlik etmektedir.",
      "aboutEdu.card4Title": "Eğitimler ve Sertifikalar",
      "aboutEdu.card4Desc": "Mesleki gelişimine önem vermekte olup Access Bars®, ThetaHealing®, JAAS ve ARUS eğitimlerini tamamlamıştır. Danışmanlık çalışmalarında farklı yaklaşımlardan yararlanarak bireyin ihtiyaçlarına uygun destek sunmayı hedeflemektedir.",
      ...
      "aboutPrinciples.card1Desc": "Görüşme sürecinde paylaşılan kişisel bilgiler gizlilik ilkesiyle korunur ve danışmanlık süreci güven temelli şekilde yürütülür.",
      "aboutPrinciples.card2Title": "Güvenli Alan",
      "aboutPrinciples.card2Desc": "Danışanın kendini yargılanmadan ifade edebilmesi, duygu ve düşüncelerini açıkça paylaşabilmesi önemsenir.",
      "aboutPrinciples.card3Title": "Bireysel İhtiyaçlara Uyum",
      "aboutPrinciples.card3Desc": "Danışmanlık süreci kişinin ihtiyaçları, hedefleri ve yaşam koşulları dikkate alınarak birlikte planlanır.",
      "aboutPrinciples.card4Title": "Etik ve Profesyonel Sınırlar",
      "aboutPrinciples.card4Desc": "Tüm görüşmeler mesleki etik ilkeler, saygı, şeffaflık ve profesyonel sınırlar gözetilerek yürütülür.",
    ...
    en: {
      ...
      "aboutEdu.card1Desc": "He graduated from Alanya Alaaddin Keykubat University, Department of Psychological Counseling and Guidance in 2021.",
      "aboutEdu.card2Title": "Professional Experience",
      "aboutEdu.card2Desc": "He started his professional career at a private counseling office in Alanya, where he worked with clients for two years. For the past two years, he has been providing individual and online counseling services at his own office in Eskişehir.",
      "aboutEdu.card3Title": "Areas of Practice",
      "aboutEdu.card3Desc": "He provides psychological counseling support in the areas of anxiety, depression, and worry. In addition, he guides his clients in educational coaching, preference counseling, academic motivation, and adaptation to life processes.",
      "aboutEdu.card4Title": "Trainings and Certificates",
      "aboutEdu.card4Desc": "He values his professional development and has completed Access Bars®, ThetaHealing®, JAAS, and ARUS trainings. He aims to provide support tailored to the individual's needs by utilizing different approaches in his counseling work.",
      ...
      "aboutPrinciples.card1Desc": "Personal information shared during sessions is protected within the principle of confidentiality, and the counseling process is built on trust.",
      "aboutPrinciples.card2Title": "Safe Space",
      "aboutPrinciples.card2Desc": "A non-judgmental environment is prioritized so clients can express their feelings and thoughts openly.",
      "aboutPrinciples.card3Title": "Individual Needs",
      "aboutPrinciples.card3Desc": "The counseling process is planned together according to the client's needs, goals, and life circumstances.",
      "aboutPrinciples.card4Title": "Ethical Boundaries",
      "aboutPrinciples.card4Desc": "All sessions are conducted with respect, transparency, professional boundaries, and ethical principles.",
